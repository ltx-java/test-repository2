                ...
                <div class="layui-form" style="float:right;">
                    <div class="layui-form-item" style="margin:0;">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="branchId" id="branchId" autocomplete="off" class="layui-input">
                        </div>
...
<#--				</td>-->
				...
				<td>
					<a href="javascript:;" data-id="{{ item.branchId }}" data-opt="view" class="layui-btn layui-btn-normal layui-btn-mini">详情</a>
					<a href="javascript:;" data-id="{{ item.branchId }}" data-opt="notify" class="layui-btn layui-btn-mini">编辑</a>
					<a href="javascript:;" data-id="{{ item.branchId }}" data-opt="del" class="layui-btn layui-btn-danger layui-btn-mini">删除</a>
				</td>
			</tr>
			{{# }); }}
		</script>
		...
		<script>
			...
			layui.use(['paging', 'form'], function() {
                ...
                paging.init({
                    openWait: true,
					url: '/branch_mag/list?v=' + new Date().getTime(), //地址
					elem: '#content', //内容容器
					params: { //发送到服务端的参数
					},
					type: 'GET',
                ...
                function viewForm(id) {
                    ...
                    $.get('/branch_mag/view.html?branchId=' + id, null, function(form) {
				...
				function editForm(branchId) {
                    //本表单通过ajax加载 --以模板的形式，当然你也可以直接写在页面上读取
                    $.get('/branch_mag/edit.html?branchId=' + branchId, null, function(form) {
                        addBoxIndex = layer.open({
                            type: 1,
                            title: '保存分店',
                            content: form,
				...
				function delForm(branchId) {
					layer.open({
						...
						yes: function(index, layero){
							//按钮【按钮一】的回调
							$.get('/branch_mag/delete?branchId=' + branchId, function(res){
								alert(res);
							});
							location.reload();
						},
